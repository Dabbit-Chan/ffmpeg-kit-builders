...
int opt_target(void *optctx, const char *opt, const char *arg)
{
    ...
    if (!strcmp(arg, "vcd")) {
        ...
        av_dict_set(&o->g->codec_opts, "maxrate:v", "1150000", 0);
        av_dict_set(&o->g->codec_opts, "minrate:v", "1150000", 0);
        av_dict_set(&o->g->codec_opts, "bufsize:v", "327680", 0); // 40*1024*8;
        ...
        av_dict_set(&o->g->codec_opts, "maxrate:v", "2516000", 0);
        av_dict_set(&o->g->codec_opts, "minrate:v", "0", 0); // 1145000;
        av_dict_set(&o->g->codec_opts, "bufsize:v", "1835008", 0); // 224*1024*8;
        av_dict_set(&o->g->format_opts, "scan_offset", "1", 0);
        ...
        av_dict_set(&o->g->codec_opts, "maxrate:v", "9000000", 0);
        av_dict_set(&o->g->codec_opts, "minrate:v", "0", 0); // 1500000;
        av_dict_set(&o->g->codec_opts, "bufsize:v", "1835008", 0); // 224*1024*8;
...
static int opt_preset(void *optctx, const char *opt, const char *arg)
{
    ...
    while (fgets(line, sizeof(line), f)) {
        ...
        else if (opt_default(o, key, value) < 0) {
