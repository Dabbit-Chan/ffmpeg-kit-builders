...
extern FFMPEG_THREAD_LOCAL InputFile   **input_files;
extern FFMPEG_THREAD_LOCAL int        nb_input_files;

extern FFMPEG_THREAD_LOCAL OutputFile   **output_files;
extern FFMPEG_THREAD_LOCAL int         nb_output_files;

// complex filtergraphs
extern FFMPEG_THREAD_LOCAL FilterGraph **filtergraphs;
extern FFMPEG_THREAD_LOCAL int        nb_filtergraphs;

// standalone decoders (not tied to demuxed streams)
extern FFMPEG_THREAD_LOCAL Decoder     **decoders;
extern FFMPEG_THREAD_LOCAL int        nb_decoders;

extern FFMPEG_THREAD_LOCAL char *vstats_filename;

extern FFMPEG_THREAD_LOCAL float dts_delta_threshold;
extern FFMPEG_THREAD_LOCAL float dts_error_threshold;

extern FFMPEG_THREAD_LOCAL enum VideoSyncMethod video_sync_method;
extern FFMPEG_THREAD_LOCAL float frame_drop_threshold;
extern FFMPEG_THREAD_LOCAL int do_benchmark;
extern FFMPEG_THREAD_LOCAL int do_benchmark_all;
extern FFMPEG_THREAD_LOCAL int do_hex_dump;
extern FFMPEG_THREAD_LOCAL int do_pkt_dump;
extern FFMPEG_THREAD_LOCAL int copy_ts;
extern FFMPEG_THREAD_LOCAL int start_at_zero;
extern FFMPEG_THREAD_LOCAL int copy_tb;
extern FFMPEG_THREAD_LOCAL int debug_ts;
extern FFMPEG_THREAD_LOCAL int exit_on_error;
extern FFMPEG_THREAD_LOCAL int abort_on_flags;
extern FFMPEG_THREAD_LOCAL int print_stats;
extern FFMPEG_THREAD_LOCAL int64_t stats_period;
extern FFMPEG_THREAD_LOCAL int stdin_interaction;
extern FFMPEG_THREAD_LOCAL AVIOContext *progress_avio;
extern FFMPEG_THREAD_LOCAL float max_error_rate;

extern FFMPEG_THREAD_LOCAL char *filter_nbthreads;
extern FFMPEG_THREAD_LOCAL int filter_complex_nbthreads;
extern FFMPEG_THREAD_LOCAL int filter_buffered_frames;
extern FFMPEG_THREAD_LOCAL int vstats_version;
extern FFMPEG_THREAD_LOCAL int print_graphs;
extern FFMPEG_THREAD_LOCAL char *print_graphs_file;
extern FFMPEG_THREAD_LOCAL char *print_graphs_format;
extern FFMPEG_THREAD_LOCAL int auto_conversion_filters;

extern const AVIOInterruptCB int_cb;

extern FFMPEG_THREAD_LOCAL OptionDef options[];
...
extern FFMPEG_THREAD_LOCAL int recast_media;

extern FFMPEG_THREAD_LOCAL FILE *vstats_file;
