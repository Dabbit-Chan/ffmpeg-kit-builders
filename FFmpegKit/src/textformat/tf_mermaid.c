...
static FFMPEG_THREAD_LOCAL const char *init_directive = ""
    "%%{init: {"
        "\"theme\": \"base\","
        "\"curve\": \"monotoneX\","
        "\"rankSpacing\": 10,"
...
static FFMPEG_THREAD_LOCAL const char* init_directive_er = ""
    "%%{init: {"
        "\"theme\": \"base\","
        "\"layout\": \"elk\","
        "\"curve\": \"monotoneX\","
...
static FFMPEG_THREAD_LOCAL const char *theme_css_er = ""
