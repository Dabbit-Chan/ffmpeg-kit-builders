...
#ifndef FFMPEG_KIT_FFPLAY_SESSION_COMPLETE_CALLBACK_H
#define FFMPEG_KIT_FFPLAY_SESSION_COMPLETE_CALLBACK_H
 ...
 * <code>FFplay</code> session has ended. <p>Session has either
...
typedef std::function<void(
    const std::shared_ptr<ffmpegkit::FFplaySession> session)>
    FFplaySessionCompleteCallback;


} // namespace ffmpegkit

#endif // FFMPEG_KIT_FFPLAY_SESSION_COMPLETE_CALLBACK_H
